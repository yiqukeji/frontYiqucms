...
(function($, window, document, undefined) {
  ...
  runCode.prototype = {
    init: function() {
      var dialog = '<div class="preview-wrap"><div class="inner"><div class="bar"><span>代码</span><span>效果</span><button class="btn-preview">►</button><label class="label"><input class="watch-code" type="checkbox">自动运行</label><i class="btn-close-view">历史编辑</i><i class="btn-close-view1">还原</i><i class="btn-close-view2">保存</i></div><div class="con"><pre><code id="codeContent" contenteditable name="editcode" class="js"></code></pre><iframe id="preview" frameborder="0"></iframe></div></div></div>';
...
*根据免费公布的GNU通用公共许可证条款
*软件基础；许可证的版本2，或（按您的选择）
*任何其他版本。
*这个程序是分布式的，希望它有用，但不需要。
*任何担保，甚至没有默示保证的适销性或
*适合特定用途。见GNU通用公共许可证
*更多细节。
*您应该已经收到了GNU通用公共许可证的副本。
*使用此程序；如果没有，请写给自由软件基金会，51
*富兰克林街，波士顿第五楼，USA. 02110-1301
 *
\******************************************************************************/
var DlHighlight;
(function() {
